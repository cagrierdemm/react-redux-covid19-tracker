...
function Covid() {
    ...
    // Check if countries array is undefined or empty
    ...
    const data = [
        {
          quarter: 1,
          person: parseInt(countries[selectedCountry]?.totalCases.replace(/,/g, ''), 10) || 0,
          label: countries[selectedCountry]?.totalCases || "N/A"
        },
        {
          quarter: 2,
          person: parseInt(countries[selectedCountry]?.totalDeaths.replace(/,/g, ''), 10) || 0,
          label: countries[selectedCountry]?.totalDeaths || "N/A"
        },
        {
          quarter: 3,
          person: parseInt(countries[selectedCountry]?.totalRecovered.replace(/,/g, ''), 10) || 0,
          label: countries[selectedCountry]?.totalRecovered || "N/A"
        },
      ];
                ...
                <div className='col-md-3 col-8 mx-auto'>
                    <div className='row d-flex'>
                        ...
                        <div className="col-2 d-flex align-items-center justify-content-center">
                           <a href='https://github.com/cagrierdemm'> <img src="./github.png" className="img-fluid hover" alt="GitHub Logo" style={{ height: "32px", width: "32px" }} /></a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div className='row col-md-12 col-lg-8 d-flex justify-content-center mx-auto'>
                                <div className="card text-center col-md-3 mb-3 mx-2 mb-md-0 bg-info border-0 border-bottom text-white">
                                    ...
                                    <div className="card-body my-4">
                                        <h3 className="card-title mb-5">{total.result.totalCases}</h3>
                                    </div>
                                ...
                                <div className="card text-center col-md-3 mb-3 mx-2 mb-md-0 border-0 bg-danger text-white">
                                    ...
                                    <div className="card-body my-4">
                                        <h3 className="card-title mb-5">{total.result.totalDeaths}</h3>
                                    </div>
                                </div>
                                <div className="card text-center col-md-3 mb-3 mx-2 mb-md-0 border-0 bg-opacity-75 bg-success text-white">
                                    ...
                                    <div className="card-body my-4">
                                        <h3 className="card-title mb-5">{total.result.totalRecovered}</h3>
                                    </div>
                                </div>
                            </div>
                            <div className='row col-md-9 col-lg-6 col-12 mx-auto mt-4'>
                                <h3>Select Country:</h3>
                                <select className="form-select mt-2" aria-label="Default select example" onChange={(e) => setSelectedCountry(e.target.selectedIndex)}>{countries.map((i, k) => (
